...
<body>
    <div class="home-container">
        ...
        <div class="home-content">
            <p class="word-wrap">Halo <strong><?=$_SESSION["nama-depan"] . " " . $_SESSION["nama-tengah"] . " " . $_SESSION["nama-belakang"]?> </strong>, Selamat datang di Aplikasi Pengelolaan Keuangan</p>
        </div>
    </div>
</body>
</html>